/* global paper, project, view, tool, Key, Color, Point, Tool, Size, Image, Path, PointText */
  ...
  NotedTools.text.onMouseUp = function (event) {
    ...
    if (result && result.item.className === 'PointText') {
      ...
      this.currentText = new PointText({
        ...
        fontFamily: 'Arial, Helveceta, DejaVu Sans, sans-serif',
